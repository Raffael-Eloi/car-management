<template>
  <b-card class="m-5" v-if="active">
    <b-card-title class="text-center">Visualizar veículo</b-card-title>
    <b-form>
        <b-row>
          <b-col>
            <b-form-group label="Marca" label-for="input-brand">
              <b-form-input id="input-brand" type="text" disabled v-model="form.inputs.brand">
              </b-form-input>
            </b-form-group>
          </b-col>
          ...
          <b-col>
            <b-form-group label="Modelo" label-for="input-model">
              <b-form-input id="input-model" type="text" disabled v-model="form.inputs.model"></b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col>
            <b-form-group label="Placa" label-for="input-license-plate">
              <b-form-input id="input-license-plate" type="text" disabled v-model="form.inputs.license_plate"></b-form-input>
            </b-form-group>
          </b-col>

          <b-col>
            <b-form-group label="Ano/Modelo" label-for="input-state">
              <b-form-input disabled v-model="form.inputs.year_model"></b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col>
            <b-form-group label="Cor" label-for="input-color">
              <b-form-input id="input-color" type="text" disabled v-model="form.inputs.color"></b-form-input>
            </b-form-group>
          </b-col>

          <b-col>
            <b-form-group label="Quantidade de eixos" label-for="input-axle-quantity">
              <b-form-input id="input-axle-quantity" type="number" disabled v-model="form.inputs.axle_quantity">
              </b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col>
            <b-form-group label="Torque" label-for="input-torque">
              <b-form-input id="input-torque" type="number" disabled v-model="form.inputs.torque">
              </b-form-input>
            </b-form-group>
          </b-col>
        ...
        <b-row>
          <b-col>
            <b-form-group label="Relação 1ª Marcha" label-for="input-relation-first-gear">
              <b-form-input id="input-relation-first-gear" type="number" step="0.01" disabled v-model="form.inputs.relation_first_gear">
              </b-form-input>
            </b-form-group>
          </b-col>
          ...
          <b-col>
            <b-form-group label="Relação diferencial" label-for="input-axle_differential">
              <b-form-input id="input-axle_differential" type="number" step="0.01" disabled v-model="form.inputs.axle_differential"></b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
