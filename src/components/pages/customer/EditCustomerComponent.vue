<template>
  <b-card class="m-5" v-if="active">
    <b-card-title class="text-center">Editar cliente</b-card-title>
    <b-form @submit.prevent="updateCustomer()">
      ...
      <b-row class="mt-5">
        ...
        <b-col class="d-flex justify-content-center">
          <b-button type="submit" variant="success" @click.prevent="updateCustomer()" :disabled="form.loading">
...
export default { 
  ...
  methods: {
    ...
    afterSuccessfulUpdate () {
      this.showSuccessMessage("Conluído! Cliente atualizado com sucesso!");
      this.close();
    },
    ...
    afterErrorUpdate (error) {
      ...
      this.showErrorMessage("Ops! Ocorreu um erro ao editar o cliente!")
    },
