  ...
  <b-card class="m-5" v-if="active">
    ...
    <b-form @submit.prevent="storeCustomer()">
        ...
        <b-row class="mt-5">
          ...
          <b-col class="d-flex justify-content-center">
            <b-button type="submit" variant="success" @click.prevent="storeCustomer()" :disabled="form.loading">
...
export default { 
  ...
  methods: {
    ...
    afterErrorStore (error) {
      ...
      this.showErrorMessage("Ops! Ocorreu um erro ao cadastrar um novo cliente!")
    },
