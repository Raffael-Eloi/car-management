  ...
  <b-card class="m-5" v-if="active">
    ...
    <b-form @submit.prevent="updateUser()">
      <b-row>
        ...
        <b-col>
          <b-form-group label="CPF/CPNJ" label-for="input-document">
            <b-form-input id="input-document" v-maska="['###.###.###-##', '##.###.###/###-##']" type="text" v-model="form.inputs.document" placeholder="Digite o documento" :class="form.errors.document ? 'has-error-custom' : ''">
            </b-form-input>
      ...
      <b-row>
        ...
        <b-col>
          <b-form-group label="Telefone" label-for="input-phone">
            <b-form-input id="input-phone" type="text" v-maska="'(##) #####-####'" v-model="form.inputs.phone" placeholder="Digite o telefone" :class="form.errors.phone ? 'has-error-custom' : ''">
            </b-form-input>
      ...
      <b-row class="mt-5">
        ...
        <b-col class="d-flex justify-content-center">
          <b-button type="submit" variant="success" @click.prevent="updateUser()" :disabled="form.loading">
