  ...
  <b-card class="m-5" v-if="active">
    ...
    <b-form @submit.prevent="updateGearbox()">
        ...
        <b-row class="mt-5">
          ...
          <b-col class="d-flex justify-content-center">
            <b-button type="submit" variant="success" @click.prevent="updateGearbox()" :disabled="form.loading">
...
export default { 
  ...
  methods: {
    ...
    afterSuccessfulUpdate () {
      this.showSuccessMessage("Conluído! Caixa de marcha atualizada com sucesso!");
      this.close();
    },
    ...
    afterErrorUpdate (error) {
      ...
      this.showErrorMessage("Ops! Ocorreu um erro ao editar a caixa de marcha!")
    },
